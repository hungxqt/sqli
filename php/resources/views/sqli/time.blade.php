...
<head>
    ...
    <style>
        ...
        .timing-display { font-size: 20px; font-weight: bold; text-align: center; padding: 15px; margin: 15px 0; border-radius: 8px; background-color: #e7f3ff; border: 2px solid #b3d9ff; }
        .slow-response { background-color: #fff3cd; border-color: #ffeaa7; color: #856404; }
        .fast-response { background-color: #d4edda; border-color: #c3e6cb; color: #155724; }
    </style>
</head>
<body>
    <div class="container">
        ...
        <form method="GET" action="{{ route('sqli.time') }}">
        ...
        @elseif($searchTerm !== null && $result)
            <div class="result-box success"><strong>{{ $result }}</strong></div>
